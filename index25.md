...
<div id="quiz-container" style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; border: 1px solid #d1d5da; color: #24292e; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif;">
  ...
  <div id="q3-box" style="margin-bottom: 20px; padding: 15px; border-radius: 8px;">
    <p><strong>3. If a US company opens and operates a new factory in Vietnam, this is:</strong></p>
  ...
  <div id="q4-box" style="margin-bottom: 20px; padding: 15px; border-radius: 8px;">
    <p><strong>4. Why are property rights essential for economic growth?</strong></p>
  ...
  <div id="q5-box" style="margin-bottom: 20px; padding: 15px; border-radius: 8px;">
    <p><strong>5. Which of the following is an "outward-oriented" policy?</strong></p>
...
function checkQuiz25() {
  ...
  const total = 5;
  const solutions = {
    q1: { ans: "B", note: "Human capital specifically refers to the skills and education of the labor force." },
    q2: { ans: "B", note: "Poor countries grow faster because initial capital investments have a much larger impact on their low productivity levels." },
    q3: { ans: "C", note: "Because the investment is owned and operated by a foreign entity, it is FDI." },
    q4: { ans: "B", note: "Property rights are a prerequisite for the price system and investment to function safely." },
    q5: { ans: "C", note: "Outward-oriented policies focus on integrating a nation into the world economy by removing trade barriers." }
  };
